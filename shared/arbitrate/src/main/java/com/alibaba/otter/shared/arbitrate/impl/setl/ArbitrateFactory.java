...
public class ArbitrateFactory implements ApplicationContextAware {
    ...
    private static Map<Long, Map<Class, Object>> cache   = MigrateMapUtil.makeComputingMap(new Function<Long, Map<Class, Object>>() {

                                                             public Map<Class, Object> apply(final Long pipelineId) {
                                                                 return MigrateMapUtil.makeComputingMap(new Function<Class, Object>() {
